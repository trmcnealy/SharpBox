...
namespace AppLimit.CloudComputing.SharpBox.StorageProvider.API
{
    ...
    {        
        ...
        {
            return GenericStorageProviderFactory.CreateFileSystemEntry(session, Name, DateTime.Now, 0, parent);
        }
        ...
        {
            return GenericStorageProviderFactory.CreateDirectoryEntry(session, Name, DateTime.Now, parent);
        }
